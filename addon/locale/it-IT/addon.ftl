...
service-customllm-dialog-model-hint=Usa l'ID esatto fornito dal tuo provider, ad esempio deepseek-chat o deepseek-reasoner (DeepSeek), deepseek-v4-flash o glm-5.3-flash (OpenCode Zen). Gli ID disponibili cambiano nel tempo.
