...
service-customllm-dialog-model-hint=请填写服务商提供的准确模型 ID，例如 deepseek-chat、deepseek-reasoner（DeepSeek），deepseek-v4-flash、glm-5.3-flash（OpenCode Zen）。可用模型会随时间变化。
